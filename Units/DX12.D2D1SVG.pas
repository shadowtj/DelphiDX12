...
type
    ...
    ID2D1SvgElement = interface(ID2D1Resource)
        ...
        function GetSpecifiedAttributeName(index: UINT32; out Name: PWideChar; nameCount: UINT32; out Ainherited: boolean): HResult; stdcall;
        ...
        function SetAttributeValue(Name: PWideChar; AType: TD2D1_SVG_ATTRIBUTE_STRING_TYPE; Value: PWideChar): HResult; stdcall; overload;
        function GetAttributeValue(Name: PWideCHAR; AType: TD2D1_SVG_ATTRIBUTE_STRING_TYPE; out Value: PWideCHAR; valueCount: UINT32): HResult; stdcall; overload;
        function GetAttributeValueLength(Name: PWideCHAR; AType: TD2D1_SVG_ATTRIBUTE_STRING_TYPE; out valueLength: UINT32): HResult; stdcall;
        function SetAttributeValue(Name: PWideCHAR; AType: TD2D1_SVG_ATTRIBUTE_POD_TYPE; Value: PByte; valueSizeInBytes: UINT32): HResult; stdcall; overload;
